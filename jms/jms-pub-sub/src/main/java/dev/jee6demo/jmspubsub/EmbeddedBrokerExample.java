...
/*	This file has been taken and modified from Open Message Queue 4.4, a java.net (Kenai) project
 *  https://mq.java.net/4.4-content/embedded-example.html
 *  https://mq.java.net/4.4-content/EmbeddedBrokerExample.java
 * 
 */
...
public class EmbeddedBrokerExample {
	...
	private static final String IMQ_HOME = EmbeddedBrokerExample.class.getClassLoader().getResource("openmq").getPath();
